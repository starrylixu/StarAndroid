...
![](http://starrylixu.oss-cn-beijing.aliyuncs.com/a5b04cd491bc341ef82224ac2318bfa2.jpeg)
# 上期回顾
...
```
![](http://starrylixu.oss-cn-beijing.aliyuncs.com/e1e350d18ff854554d4e2497e0296c9e.png)
添加依赖
```java
implementation("com.squareup.okhttp3:okhttp:4.9.3")
```
![](http://starrylixu.oss-cn-beijing.aliyuncs.com/bf19c1f6ab4437bfa0eb9c85871f02e0.png)
# okhttp使用步骤
...
![](http://starrylixu.oss-cn-beijing.aliyuncs.com/b6f27757a0c3e5976cfbb4d84ebcdee4.jpeg)
## 发起异步请求
...
![](http://starrylixu.oss-cn-beijing.aliyuncs.com/347121a6a655e9f2d43deb6ffab2600f.png)
...
![](http://starrylixu.oss-cn-beijing.aliyuncs.com/c3ee084dd477f6f2f52890b88b772d00.gif)
第三步：解析数据
```java
...
```
![](http://starrylixu.oss-cn-beijing.aliyuncs.com/8e55da690f522e8d7b1fd93e167de48f.png)
第四步：设置到文本控件上显示
我们先得给文本控件取一个id，为了方便查看，我设置了文本的大小和颜色
![](http://starrylixu.oss-cn-beijing.aliyuncs.com/d34ab2fc95a1d8400b44548665e8b8c2.png)
然后将解析出的数据设置到文本控件上
同样的在okhttp中我们需要切换线程到主线程来设置数据到控件上，说明okhttp框架只帮我们解决了构建子线程的问题，线程切换还是需要自己实现
![](http://starrylixu.oss-cn-beijing.aliyuncs.com/a9cbf7f0858571cf79d208bc2c43a9d8.png)
运行可以看到名字已经解析出来并显示在虚拟机上
![](http://starrylixu.oss-cn-beijing.aliyuncs.com/dc9bcddf52e5d132eb522bd66edbdc31.png)
...
![](http://starrylixu.oss-cn-beijing.aliyuncs.com/096da1671e8a3c92e0732c0b05e8ac28.png)
...
![](http://starrylixu.oss-cn-beijing.aliyuncs.com/3fbd71b5c4ec2c730c4beddac75cc093.png)
...
![](http://starrylixu.oss-cn-beijing.aliyuncs.com/042070a3b9af0238e4c19943c9bc97f8.png)
...
![](http://starrylixu.oss-cn-beijing.aliyuncs.com/ad45265e7952a093d8cd0fac82de3049.png)

通过debug级的日志过滤我们可以查看数据请求的状态信息和数据解析结果，也方便我们排错分析

![](http://starrylixu.oss-cn-beijing.aliyuncs.com/8c114e6deb18276b7ba552e2c24cb70e.png)
