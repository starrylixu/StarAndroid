...
![](/images/38b151a6d5c04f83f70abefcb8a578b7.PNG)
...
![](/images/57ff9a209f88b3d8281c406402939948.png)
...
![](/images/252d6bc540a76444c661d47634eebfe8.png)
...
![](/images/df53ee12544e4836bcfa96b021923b82.png)
...
![](/images/05a4c1da5ca4ae57eddf3c8fe9fd4bae.png)

在`App Inspection`可以查看数据库的表结构

这种查看数据库表结构的方式必须要求虚拟机在API26及以上

![](/images/ffc2f80da2566381c5d39e3277704391.png)

数据库文件存放在`/data/data/<package name>/databases/`目录下

![](/images/15b9400790c5f7eb0a99f73db1cf5d92.png)
...
![](/images/6cd6497624d8247e9af7ec50b50b7c9c.png)
...
![](/images/306f9c1d6ed4d69236b0f137b7097cad.png)
...
![](/images/b317c4f3c0ac8a778c72eaadd0ad40db.png)
...
![](/images/9418d9eee688f26c929760e6556bea4b.png)

点击删除数据，可以看到id=2的数据已被删除

![](/images/75fc73f8ccea076c73b641414ff4c03a.png)

点击查询数据按钮，在日志打印台通过tag过滤日志可以看到，成功查询到id=1的记录

![](/images/4fefae09bde283b29a697ddef6ababa9.png)
...
![](/images/73b7bd07dc547aa007558c0df5a8b554.png)

可以看到这个动态生成的实现类都实现了接口中的方法

![](/images/c2b6339a878f5259a0cc6298d1fc78f9.png)
